...
class EdgeCaseTestSuite:
    ...
    def run_edge_case_tests(self, algorithm_name: str, algorithm_instance) -> List[EdgeCaseResult]:
        """
        Run all edge case tests on a given algorithm.
        
        Args:
            algorithm_name: Name of the algorithm (e.g., "DNSHA2-256")
            algorithm_instance: Instance of the algorithm class
        ...
        for test_name, data, description in test_inputs:
            try:
                ...
                print(f"  {status} {test_name:<35} | {len(data):>5} bytes | {description}")
                ...
                results.append(result)
                print(f"  âœ— {test_name:<35} | ERROR: {e}")
...
class MasterValidationSuite:
    ...
    def run_complete_validation(self):
        ...
        for alg_name, alg_instance in self.dna_sha_algorithms.items():
            results = self.edge_case_suite.run_edge_case_tests(alg_name, alg_instance)
